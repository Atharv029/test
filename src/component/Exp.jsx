...
const Exp = () => {
  return (
    <div className='container h-[200%] w-full absolute left-0 top-[390%] bg-[#fff5ea]'>
      ...
      <img src="https://i.postimg.cc/4yRJj2z9/icons8-orange-circle-48.png" alt="dot" loading='lazy' className='w-[30px] absolute top-[31.7%] left-[5.9%]' />
      <p className='font-Jost font-[500] text-2xl absolute top-[31.5%] left-[9%]'>Education</p>

      <img src="https://i.postimg.cc/4yRJj2z9/icons8-orange-circle-48.png" alt="dot" loading='lazy' className='w-[30px] absolute top-[57.6%] left-[5.9%]' />
      <p className='font-Jost font-[500] text-2xl absolute top-[57.4%] left-[9%]'>Skills</p>

      <img src="https://i.postimg.cc/4yRJj2z9/icons8-orange-circle-48.png" alt="dot" loading='lazy' className='w-[30px] absolute top-[84.8%] left-[5.9%]' />
